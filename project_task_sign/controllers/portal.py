...
class CustomerPortal(portal.CustomerPortal):
    ...
    @http.route(['/my/tasks/<int:task_id>/project_task/sign/<string:source>'], type='json', auth="public", website=True)
    def project_task_sign(self, task_id, access_token=None, source=False, name=None, signature=None):
