...
class TaskSignCustomerPortal(project.ProjectCustomerPortal):
    ...
    def _task_get_page_view_values(self, task, access_token, **kwargs):
        ...
        if access_token and task and task.allow_customer_signature and request.env.user._is_public():
            domain = request.env['account.analytic.line']._signature_timesheet_get_portal_domain()
